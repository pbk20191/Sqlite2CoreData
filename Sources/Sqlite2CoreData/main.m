...
int main(int argc, const char * argv[])
{
    ...
    @autoreleasepool {
        ...
        SQCDDatabaseHelper* helper = [SQCDDatabaseHelper new];
        BOOL xcModelGenerated = [[SQCDDataModelGenerator.alloc initWithHelper:helper] generateCoreDataModelFromDBPath:dbPath
        ...
        [SQCDMigrationManager startDataMigrationWithDBPath:dbPath
                                                  momdPath:momdPath
                                                outputPath:outputPath helper:helper];
